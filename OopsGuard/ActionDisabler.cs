...
public class ActionDisabler
{
    ...
    public ActionDisabler()
    {
        getActionStatusHook = Service.GameInteropProvider.HookFromAddress<OnGetActionStatusDelegate>(ActionManager.Addresses.GetActionStatus.Value, GetActionStatusDetour);
        getActionStatusHook.Enable();
    }

    private unsafe uint GetActionStatusDetour(IntPtr self, uint actionType, uint actionID, ulong a3, bool a4, bool a5, UIntPtr a6)
    {
